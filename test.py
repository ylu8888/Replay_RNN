...
#coords is just GPS coordinates of users
...
locs = [[101, 102, 103, 104], [201, 202, 203, 204]] # the locations of the users, where they went
...
for i in range(len(dataset)):  # loop through all available batches
    x, t, t_slot, s, y, y_t, y_t_slot, y_s, reset_h, active_users = dataset.__getitem__(i)
